...
`.trim()
	...
	if (banned === true) throw `MeduS.A-bot® | *「 BANEO v2 」*\n\n ${username} ESTA BANEADO POR: ${motivoban} 
	...
	if (rango === "HeadStaff") throw `MeduS.A-bot® | *「 RANGO 」*\n\nEste usuario, ${username} , es un HEADSTAFF oficial de MeduS.A-BOT.`
	if (rango === "Staff") throw `MeduS.A-bot® | *「 RANGO 」*\n\nEste usuario, ${username} , es un STAFF oficial de MeduS.A-BOT.`
